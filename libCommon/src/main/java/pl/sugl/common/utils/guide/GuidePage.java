package pl.sugl.common.utils.guide;
...
public class GuidePage {
    ...
    private int knowViewId = View.NO_ID;
...
//            guidePage.setCloseOnTouchOutside();
    ...
    public void setLayoutView(){
        rootLayout = (ViewGroup) activity.getWindow().getDecorView();
        layoutView = View.inflate(activity, layoutId, null);
    }

    public void setKnowEvent(){
        if(layoutView!=null && knowViewId != View.NO_ID) {

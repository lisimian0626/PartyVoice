...
public class AppBarLayoutCollapseBehavior extends AppBarLayout.Behavior {
    ...
    public AppBarLayoutCollapseBehavior() {
    }

    public AppBarLayoutCollapseBehavior(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    private static class RecyclerViewScrollListener extends RecyclerView.OnScrollListener {
        ...
        private WeakReference<AppBarLayoutCollapseBehavior> behaviorWeakReference;

        public RecyclerViewScrollListener(CoordinatorLayout coordinatorLayout, AppBarLayout child, AppBarLayoutCollapseBehavior barBehavior) {
            coordinatorLayoutRef = new WeakReference<CoordinatorLayout>(coordinatorLayout);
            childRef = new WeakReference<AppBarLayout>(child);
            behaviorWeakReference = new WeakReference<AppBarLayoutCollapseBehavior>(barBehavior);
        }

package pl.sugl.common.widget.decoration;
...
public abstract class FlexibleDividerDecoration extends RecyclerView.ItemDecoration {
    ...
    protected int mHeadCount, mFooterCount;
    ...
    protected FlexibleDividerDecoration(Builder builder) {
        ...
        mHeadCount = builder.mHeadCount;
        mFooterCount = builder.mFooterCount;
    }
    ...
    public void onDraw(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        childCount -= mFooterCount;
        for (int i = mHeadCount; i < childCount; i++) {
    ...
    public static class Builder<T extends Builder> {
        ...
        public T headCount(int count) {
            mHeadCount = count;
            return (T) this;
        }

        public T footerCount(int count) {
            mFooterCount = count;
            return (T) this;
        }

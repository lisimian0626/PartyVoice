package pl.sugl.common.widget.controller;
...
public class VideoControllerView extends FrameLayout implements VideoGestureListener {
    ...
    private static final int HANDLER_PAUSE_PLAY = 3;
    ...
    private boolean mIsShowing = true;//controller view showing
    ...
    public VideoControllerView(Builder builder) {
        ...
        this.mShowTopTitle = builder.showTopTitle;
        this.mPlayPauseListener = builder.playPauseListener;
    ...
    public void onPrepared() {
        mCurrentTime.setText(stringToTime(mMediaPlayerControlListener.getCurrentPosition()));
        mEndTime.setText(stringToTime(mMediaPlayerControlListener.getDuration()));
    }
    ...
    public static class Builder {
        ...
        private boolean showTopTitle = true;
        ...
        @DrawableRes
        private int exitIcon = R.drawable.top_back;
        @DrawableRes
        private int pauseIcon = R.drawable.mv_pause;
        @DrawableRes
        private int playIcon = R.drawable.mv_play;
        @DrawableRes
        private int shrinkIcon = R.drawable.mv_window;
        @DrawableRes
        private int stretchIcon = R.drawable.mv_fullscreen;
        ...
        public Builder with(@Nullable Context context) {
            this.context = context;
            return this;
        }
        ...
        public Builder showTopTitle(boolean show) {
            showTopTitle = show;
            return this;
        }

        public Builder setPlayPauseListener(View.OnClickListener listener) {
    ...
    private void initControllerView() {
        ...
        mVideoCover = (ImageView) mRootView.findViewById(R.id.iv_video_cover);
        ...
        mLoading = (ProgressBar) mRootView.findViewById(R.id.progressbar);
...
//                break;// do need bread,should let gestureDetector to handle event
    ...
    private void togglePausePlay() {
        ...
        mHandler.sendEmptyMessage(HANDLER_PAUSE_PLAY);
        showPausePlay();
    }

    private void showPausePlay() {
    ...
    private void setAnchorView(ViewGroup view) {
        ...
        setupDefaultView();
        mTopLayout.setVisibility(mShowTopTitle ? VISIBLE : GONE);
    }
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case HANDLER_ANIMATE_OUT:
                    view.hide();
                    break;
                //cycle update seek bar progress
                case HANDLER_UPDATE_PROGRESS:
                    pos = view.setSeekProgress();
                    //just in case
                    if (!view.mIsDragging && view.mIsShowing && view.mMediaPlayerControlListener.isPlaying()) {
                        //cycle update
                        msg = obtainMessage(HANDLER_UPDATE_PROGRESS);
                        sendMessageDelayed(msg, 1000 - (pos % 1000));
                    }
                    break;
                case HANDLER_PAUSE_PLAY:
                    view.doPauseResume();
                    break;
                default:
                    break;
